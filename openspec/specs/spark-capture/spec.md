# spark-capture Specification

## Purpose

Capturing an idea as a single line in under five seconds, and listing what has
been captured.

This is the answer to beginner problem #1 ("nothing to write about"): sparks
get recorded the moment they occur instead of being lost. The list is
deliberately flat and newest-first — per the anti-features list there are no
folders, tags, or ordering options.
