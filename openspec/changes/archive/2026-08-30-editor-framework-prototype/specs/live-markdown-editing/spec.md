...
typewriter mode, and baseline text-editing correctness. Validated first by the
framework prototypes; the same requirements later govern the production editor.
