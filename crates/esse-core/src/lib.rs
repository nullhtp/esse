...
//! lifecycle, the WIP limit, the on-disk formats — lives here so it can be
//! tested without building gpui.
...
pub use model::{Essay, EssayStatus, Session, Spark, WIP_LIMIT};
pub use setup::Setup;
